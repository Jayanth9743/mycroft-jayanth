  ...
  return (
    <div className="flex justify-center w-1/2 h-full items-center gap-6 rounded-lg flex-col bg-[#efefef]">
      ...
      <div className=" flex justify-start items-center w-3/4">
        <button className="w-[9rem] h-[2.5rem] bg-black text-white rounded-xl">load config</button>
      </div>
      ...
      <div className="flex justify-center flex-col gap-1 items-start w-3/4">
        ...
        <input className="w-full p-2 outline-none bg-white rounded" type="text" id="config-name" name="config-name" />
      </div>

      <div className="flex justify-center flex-col gap-1 items-start w-3/4">
        <label className="font-semibold" htmlFor="bot-name">BotName</label>
        <input className="w-full p-2 outline-none bg-white rounded" type="text" id="bot-name" name="bot-name" />
      </div>

      <div className="flex justify-center flex-col gap-1 items-start w-3/4">
        <label className="font-semibold" htmlFor="font-family">Font family</label>
        <select name="font-family" id="font-family" className="w-full p-2 outline-none bg-white rounded">
      ...
      <div className="flex justify-center flex-col gap-1 items-start w-3/4">
        ...
        <label className="w-full flex h-10 justify-between items-center bg-white rounded" htmlFor="avatar-image">
          <img src="" alt="" />
      ...
      <div className="flex justify-center flex-col gap-1 items-start w-3/4">
        ...
        <label className="w-full flex h-10 justify-between items-center bg-white rounded" htmlFor="launcher-image">
          <img src="" alt="" />
          <FiUpload className="text-lg cursor-pointer mr-2"/> 
        </label>
